...
const AIPAComingSoon = () => (
  <div className="min-h-screen bg-gradient-to-b from-[#10151f] to-[#192233] text-white flex flex-col">
    <Navbar />
    <main className="flex-grow flex flex-col items-center justify-center">      <h1 className="text-4xl md:text-5xl font-bold mb-4 glassmorphism">
        <span>AIPA – AI Paralegal</span>
      </h1>
