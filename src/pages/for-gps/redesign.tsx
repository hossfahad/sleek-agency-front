        ...
        <section className="py-16 bg-white bg-opacity-80 backdrop-blur-sm">
          <div className="container mx-auto px-4 max-w-4xl text-center section-container py-8">
            ...
            >
              ...
              <div className="text-center">
                <div className="text-3xl font-light text-[#0A382C] mb-2">67%</div>
                <div className="text-sm text-gray-600">Faster Deal Cycles</div>
              </div>
              <div className="text-center">
...
export default GPLandingRedesign;
