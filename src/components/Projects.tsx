...
const industries = [
  {
    title: "Medical & Healthcare Providers",
    description: "Streamline patient scheduling, follow-ups, and medical record management with AI assistants and automated workflows.",
    icon: (
  ...
  },
  {
    ...
    description: "Help legal, finance, and consulting firms automate client communications, document processing, and regulatory compliance.",
    icon: (
  ...
  {
    title: "Retail & Specialty Businesses",
    description: "Enhance customer engagement, automate inventory management, and deliver personalized shopping experiences.",
    icon: (
  ...
  },
  {
    ...
    description: "Streamline candidate screening, automate interview scheduling, and enhance talent matching with AI-powered solutions.",
    icon: (
  ...
  {
    title: "Trade & Construction Services",
    description: "Optimize project scheduling, enhance client communication, and streamline administrative tasks for busy contractors.",
    icon: (
  ...
  },
  {
    ...
    description: "Automate member check-ins, class scheduling, and personalized fitness program recommendations.",
    icon: (
