...
const industries = [
  {
    ...
    description: "Streamline patient interactions, follow-ups, and medical record management with AI assistants and automated workflows that integrate into your systems",
    icon: (
  ...
  },
  {
    ...
    description: "Support large scale data servicing, client interactions, document processing, and regulatory compliance.",
    icon: (
  ...
  },
  {
    ...
    description: "Enhance customer engagement, automate inventory management, and deliver hyper-personalized shopping experiences.",
    icon: (
  ...
  },
  {
    ...
    description: "Streamline candidate screening, automate interview scheduling, talent matching and interviews.",
    icon: (
  ...
  },
  {
    ...
    description: "Detect, optimize and label project spaces, communicate internally, and analyze drawings.",
    icon: (
  ...
  },
  {
    ...
    description: "Automate member check-ins, class scheduling, and create personalized programs.",
    icon: (
